<template>
          ...
          >
            ...
            >
              <el-collapse-item
                title="基础属性"
                v-show="
                  activeComponent === undefined || activeComponent === 'one'
                "
                name="one"
              >
                <el-scrollbar class="right-scrollbar">
                  <el-form-item
                    v-if="activeDataProperty.vModel !== undefined"
                    label="字段名"
                  >
                    <el-input
                      v-model="activeDataProperty.vModel"
                      placeholder="请输入字段名（v-model）"
                    ></el-input>
                  </el-form-item>
                  <el-form-item
                    v-for="(item, key) in activeDataProperty.attr"
                    :label="item.label"
                    :key="key"
                  >
                    <el-input
              ...
              <el-collapse-item
                v-show="
                  activeComponent === undefined || activeComponent === 'two'
                "
                title="子项配置"
                name="two"
                v-if="
              ...
              <el-collapse-item
                title="插槽配置"
                v-show="
                  activeComponent === undefined || activeComponent === 'three'
                "
                name="three"
              ...
              >
                <el-scrollbar class="right-scrollbar">
                  <el-form-item
                    v-for="(item, key) in filteredSlots"
                    :label="item.label"
                    :key="key"
                  >
                    <el-input
              ...
              <el-collapse-item
                title="事件配置"
                v-show="
                  activeComponent === undefined || activeComponent === 'four'
                "
                name="four"
              ...
              >
                <el-scrollbar class="right-scrollbar">
                  <el-form-item
                    v-for="(item, key) in activeDataProperty.events"
                    :label="item.label"
                    :key="key"
                  >
                    <el-button
                      type="primary"
                      @click="handleEvent(item, key)"
        ...
        >
          ...
          >
            <el-collapse-item
              ...
              name="lifeCycle"
              v-show="
                activeGeneral === undefined || activeGeneral === 'lifeCycle'
              "
            >
              <el-scrollbar class="right-scrollbar">
                <el-form-item
                  v-for="(item, key) in generateConf.lifeCycles"
                  :label="item.label"
                  :key="key"
                >
                  <el-button
                    style="margin-right: 10px"
                    type="primary"
                    @click="handleMethod(item, 'lifeCycle', true, key)"
                    icon="Edit"
                    >编辑</el-button
                  >
                  <el-switch v-model="item.used" />
            ...
            <el-collapse-item
              ...
              name="methods"
              v-show="
                activeGeneral === undefined || activeGeneral === 'methods'
              "
            >
              <el-scrollbar class="right-scrollbar">
                <el-form-item
                  v-for="(item, key) in generateConf.methods"
                  :label="item.label"
                  :key="key"
                >
                  <el-button
                    style="margin-right: 10px"
                    type="primary"
                    @click="handleMethod(item, 'methods', true, key)"
                    icon="Edit"
                    >编辑</el-button
                  >
                  <el-switch v-model="item.used" />
  ...
  <icons-dialog
    ...
    :current="
      currentIconModel ? activeDataProperty.attr[currentIconModel] : null
    "
    @select="setIcon"
  />
  <method-edit-dialog
...
function handleEvent(item, key) {
  ...
  if (med) {
    ...
    med.value = `function ${functionName}(${item.param.join(",")}){${
      item.usedReturn ? "return;" : ""
    }}`;
    handleMethod(med, "event", true, key);
  }
}
