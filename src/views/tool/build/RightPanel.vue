<template>
  <div class="right-board">
    <el-card body-class="card-body" header-class="card-header">
      ...
      <el-form style="padding-left: 5px;padding-right: 5px;" v-show="currentTab === 'field' && showField" size="default"
        ...
        <el-collapse v-model="activeName">
          ...
          <el-collapse-item v-if="activeDataProperty.type === 'form' && activeDataProperty.hedge" title="包围属性" name="2">
            <el-scrollbar class="right-scrollbar">
