<template>
  <div class="app-container">
          ...
          <el-row :gutter="20">
            <el-col :span="8">
              <el-form-item label="标题" prop="sys.common.title">
                <el-input
                  v-model="formData['sys.common.title']"
                  type="text"
                  placeholder="请输入标题"
                  clearable
                ></el-input>
              ...
              <el-form-item label="底部" prop="sys.common.footer">
                <el-input
                  v-model="formData['sys.common.footer']"
                  type="textarea"
                  :rows="4"
                  placeholder="请输入底部代码"
                />
          ...
          <el-row :gutter="20">
            <el-col :span="8">
              ...
              <el-form-item label="介绍" prop="sys.login.info">
                <el-input
                  v-model="formData['sys.login.info']"
                  type="textarea"
                  :rows="4"
                  placeholder="请输入介绍代码"
                />
          ...
          <el-row :gutter="20">
            <el-col :span="8">
              ...
              <el-form-item label="默认部门" prop="sys.account.defaultDept">
                <el-tree-select
                  v-model="formData['sys.account.defaultDept']"
                  :data="deptTreeList"
              ...
              <el-form-item label="初始密码" prop="sys.user.initPassword">
                <el-input
                  v-model="formData['sys.user.initPassword']"
                  type="input"
                  :rows="4"
                  placeholder="请输入默认密码"
                />
              ...
              <el-form-item
                label="修改策略"
                prop="sys.account.initPasswordModify"
              >
                <el-input
                  v-model="formData['sys.account.initPasswordModify']"
                  type="text"
                  clearable
                ></el-input>
              </el-form-item>
    ...
    <el-button
      ...
      v-hasPermi="['system:setting:config']"
      >确 定</el-button
    >
  </div>
</template>
