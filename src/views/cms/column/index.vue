<template>
  <div class="app-container">
    ...
    >
      ...
      <el-form-item label="菜单类型" prop="columnType">
        <el-select
    ...
    >
      ...
      <el-table-column label="导航类型" align="center" prop="columnType" >
        <template #default="scope">
          <dict-tag :options="cms_column_type" :value="scope.row.openType" />
        </template>
      </el-table-column>
...
const { cms_yes_no ,sys_show_hide, cms_column_type, cms_link_open } = proxy.useDict(
  "cms_yes_no",
  "sys_show_hide",
  "cms_column_type",
  "cms_link_open"
...
const data = reactive({
  ...
  rules: {
    ...
    columnType: [
      { required: true, message: "栏目状态不能为空", trigger: "blur" },
    ],
    openType: [
