<template>
    <div class="app-container">
      ...
      <el-table :select-on-indeterminate="false" v-loading="loading" :data="shareList">
        ...
        <el-table-column label="分享地址" align="center" prop="shareUrl" />
  ...
  <script setup name="ArticleShare">
  import {
    listArticleShare,
  } from "@/api/cms/record";
  ...
  function getList() {
    loading.value = true;
    listArticleShare(queryParams.value).then((response) => {
