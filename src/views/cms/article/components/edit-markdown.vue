        ...
        <el-container>
            <el-header>
                    ...
                    <el-tooltip  content="预览" placement="top">
                        <el-button type="info" size="large" icon="View" @click="getHtml">预览</el-button>
                    </el-tooltip>
            </el-header>
            <el-container>
                <left :maxWidth="'25vw'">
                ...
                <el-main>
                    <el-row :gutter="20">
                        ...
                        <el-col :span="24">
                            <el-form-item label="文章内容" prop="articleMd">
...
// 表单提交
function submitForm() {
    form.value.articleContent=getHtml();
