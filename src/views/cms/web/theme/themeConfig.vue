          ...
          <el-tabs v-model="activeTab" type="border-card">
            <el-tab-pane name="tab-1" label="网站设置">
              ...
              <el-form-item label="网站主页：" prop="oly.web.index">
                <el-input v-model="formData['oly.web.index']" type="text" placeholder="请输入网站主页"></el-input>
              </el-form-item>
              ...
              <el-form-item label="网站版权：" prop="oly.web.copyright">
                <el-input type="textarea" v-model="formData['oly.web.copyright']" rows="3"
                  placeholder="请输入网站版权"></el-input>
              </el-form-item>
              <el-form-item label="页脚设置：" prop="oly.web.footer">
                <el-input type="textarea" v-model="formData['oly.web.footer']" rows="3" placeholder="请输入页脚设置"></el-input>
              </el-form-item>
            </el-tab-pane>
            <el-tab-pane name="tab-2" label="默认页面">
              ...
              <el-form-item label="分类页：" prop="oly.web.pageCategory">
                <el-input-number v-model="formData['oly.web.pageCategory']" controls-position="right" :min="0"
                  :max="100000000000" :precision="0" :step="1">
                </el-input-number>
              </el-form-item>
              <el-form-item label="标签页：" prop="oly.web.pageTag">
                <el-input-number v-model="formData['oly.web.pageTag']" controls-position="right" :min="0"
                  :max="100000000000" :precision="0" :step="1">
                </el-input-number>
              </el-form-item>
            ...
            <el-tab-pane name="tab-3" label="主题设置">
              <el-form-item label="支持类型：" prop="oly.web.article.supportType">
                <el-select v-model="formData['oly.web.article.supportType']" multiple placeholder="请选择类型"
                  style="width: 240px">
                  <el-option v-for="dict in cms_support_type" :key="dict.value" :label="dict.label"
                    :value="String(dict.value)"></el-option>
                </el-select>
              </el-form-item>
            ...
            <el-tab-pane name="tab-5" label="其他设置">
              <el-form-item label="自定义头部：" prop="oly.web.head">
                <el-input type="textarea" v-model="formData['oly.web.head']" rows="3" placeholder="请输入自定义标题"></el-input>
              </el-form-item>
              <el-form-item label="自定义脚本：" prop="oly.web.script">
                <el-input type="textarea" v-model="formData['oly.web.script']" rows="3" placeholder="请输入自定义脚本"></el-input>
              </el-form-item>
            </el-tab-pane>
          </el-tabs>
        </div>
  ...
  try {
    proxy
      ...
      .then((response) => {
        ...
        formData.value["oly.web.article.supportType"]?formData.value["oly.web.article.supportType"].split(","):[];
      });
  } catch (error) {
...
function submitForm() {
  formData.value["oly.web.article.supportType"] =
  formData.value["oly.web.article.supportType"]?formData.value["oly.web.article.supportType"].join(","):"";
