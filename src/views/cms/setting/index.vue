<template>
  ...
  <div class="ab-container">
          ...
          <el-row :gutter="20">
            <el-col :span="8">
              ...
              <el-form-item label="标签上限" prop="oly.cms.articleTag.maxNum">
                <el-input-number v-model="formData['oly.cms.articleTag.maxNum']" controls-position="right" :min="0"
                  :max="100">
                </el-input-number>
              </el-form-item>
              <el-form-item label="关键词上限" prop="oly.cms.articleKey.maxNum">
                <el-input-number v-model="formData['oly.cms.articleKey.maxNum']" controls-position="right" :min="0"
                  :max="100">
                </el-input-number>
              </el-form-item>
              <el-form-item label="预览图上限" prop="oly.cms.articleImg.maxNum">
                <el-input-number v-model="formData['oly.cms.articleImg.maxNum']" controls-position="right" :min="0"
                  :max="100">
                </el-input-number>
              </el-form-item>
              ...
              <el-form-item label="固定前缀" prop="oly.cms.articleUrl.prefix">
                <el-input v-model="formData['oly.cms.articleUrl.prefix']" type="text" clearable></el-input>
              </el-form-item>
            </el-col>
          </el-row>
      </el-tab-pane>
      <el-tab-pane name="theme" label="主题设置">
          <el-row :gutter="20">
            <el-col :span="8">
              <el-form-item label="关联分类" prop="oly.cms.category.must.theme">
                <el-switch
                  v-model="formData['oly.cms.category.must.theme']"
                ></el-switch>
              </el-form-item>
            </el-col>
          </el-row>
    ...
    <el-button type="primary" @click="submitConfigForm" v-hasPermi="['cms:setting:config']">确 定</el-button>
  </div>
</el-form>
</template>
