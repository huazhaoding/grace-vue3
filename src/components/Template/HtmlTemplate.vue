  ...
  <div class="container">
    <div class="left-board">
      ...
      <el-scrollbar class="left-scrollbar">
        ...
        >
          ...
          <el-tab-pane label="表单模板" name="forms">Config</el-tab-pane>
        </el-tabs>
      </el-scrollbar>
    </div>
    <div class="center-board">
      <div class="action-bar">
        ...
        <el-button icon="Download" type="primary" text @click="exportJson">
          导出JSON
        </el-button>
        <el-button icon="Download" type="primary" text @click="importJson">
          导入JSON
        </el-button>
        <el-button icon="Download" type="primary" text @click="view">
          预览
        </el-button>
        <el-button
          class="copy-btn-main"
